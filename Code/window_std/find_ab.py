...
std1_1,max_position1,max1=redata(data1_1)
mark1_1=np.max(std1_1[2002:2022])
std1_2,max_position2,max2=redata(data1_2)
mark1_2=np.max(std1_2[2002:2022])
std1_3,max_position3,max3=redata(data1_3)
mark1_3=np.max(std1_3[2002:2022])
std1_4,max_position4,max4=redata(data1_4)
mark1_4=np.max(std1_4[2002:2022])
std1_5,max_position5,max5=redata(data1_5)
...
x1_1=range(2022)
plt.plot(x1_1,std1_1,color='b')
plt.plot(a1_1,std1_1[a1_1],marker='o', color='coral')
plt.plot(b1_1,std1_1[b1_1],marker='o', color='coral')
plt.show()
